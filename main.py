...
# -----------------------------------------------------------
# 1. إجبار بايثون على استخدام IPv4 فقط لحل مشكلة (Errno 101) في الاستضافات
...
# -----------------------------------------------------------
# 2. نظام البروكسي (معطل افتراضياً - استخدمه فقط إذا استمر الحظر)
# import socks
# PROXY_IP = "188.226.141.211" # ضع اي بي بروكسي SOCKS5 هنا
# PROXY_PORT = 1080            # ضع البورت هنا
